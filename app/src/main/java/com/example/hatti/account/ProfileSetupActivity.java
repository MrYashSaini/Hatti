...
public class ProfileSetupActivity extends AppCompatActivity {
    ...
    Button update;
    TextView name,gmail,phone,dob,address,city,state,gender;
//    RadioButton rbMale,rbFemale;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.getReference().child("users").child(auth.getCurrentUser().getUid()).child("profile")
...
//                    profileModel.setProfile_photo("");
//                    profileModel.setShop_photo("");
